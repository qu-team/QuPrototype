...
public class L10N : MonoBehaviour {
    ...
    private class English : Language {
        public English() : base(new Dictionary<Label, string>() {
            ...
            { Label.CARD_3_TASK, "Score at least 800 points in 5 levels" },
            ...
            { Label.CARD_7_TASK, "Reach the last level" },
            ...
            { Label.CARD_11_TASK, "Complete the blinding level" },
            ...
            { Label.CARD_16_TASK, "Play for 1 hour (total)" },
            ...
            { Label.CARD_18_TASK, "score more than 1000 in a level" },
            ...
            { Label.ANIMATION_8_TEXT, "It's time to go home" },
            { Label.ANIMATION_9_TEXT, "We're almost there" },
            { Label.ANIMATION_10_TEXT, "THANKS" },
            { Label.INTRO1, "Please" },
    ...
    private class Italian : Language {
        public Italian() : base(new English(), new Dictionary<Label, string>() {
            ...
            { Label.CARD_3_TASK, "Totalizza almeno 800 punti in 5 livelli" },
            ...
            { Label.CARD_7_TASK, "Raggiungi l'ultimo livello" },
            ...
            { Label.CARD_11_TASK, "Completa il livello accecante" },
            ...
            { Label.CARD_16_TASK, "Gioca per almeno 1 ora (in totale)" },
            ...
            { Label.CARD_18_TASK, "Ottieni pi" + UGRAVE + " di 1000 punti in un livello" },
            ...
            { Label.ANIMATION_6_TEXT, "Abbiamo visto il vostro mondo" },
            { Label.ANIMATION_7_TEXT, "Abbiamo portato i colori" },
            { Label.ANIMATION_8_TEXT, "Ora dobbiamo tornare a casa" },
            { Label.ANIMATION_9_TEXT, "Ci siamo quasi" },
            { Label.ANIMATION_10_TEXT, "GRAZIE!" },
